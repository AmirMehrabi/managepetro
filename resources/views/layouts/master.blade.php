...
<head>
    ...
    <link href="{{ asset("src/css/light/loader.css") }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset("src/css/dark/loader.css") }}" rel="stylesheet" type="text/css" />
    <script src="{{ asset("src/loader.js") }}"></script>
